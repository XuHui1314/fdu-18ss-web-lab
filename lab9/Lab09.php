...
<body>
    ...
    <main class="container">
		...
		<ul class="caption-style-2">
          ...
          //you need to fill the elements with data providedkk
   ...
   //              </a>
			// </li>
          $list=array(22,54,7,19,46,6,60,58,75,77,27,2,24,13,101,102);
          foreach ($list as $value){
              $id=$images[$value]["id"];
              $path=$images[$value]["path"];
              $title=$images[$value]["title"];
              echo "<li>
                 <a href=\"detail.php?id=$id \" class=\"img-responsive\">
                 	<img src=\"images/square/$path\" alt=\"View of Cologne\">
                 	<div class=\"caption\">
                 		<div class=\"blur\">
                 		</div>
                 		<div class=\"caption-text\">
